    ...
    <Layout>
      ...
      <article className="mx-auto max-w-3xl px-4 py-10 prose-content">
        ...
        <p className="mt-3 text-[15px] leading-relaxed text-foreground/90">
          ...
          seperti Kota Madya Gunungsitoli, Kabupaten Nias, Kabupaten Nias Utara, Kabupaten Nias
          Barat, dan Kabupaten Nias Selatan. Dengan demikian, pengguna dapat mempelajari variasi
          penggunaan Bahasa Nias yang berkembang di berbagai daerah di Pulau Nias.
        </p>
        <p className="mt-3 text-[15px] leading-relaxed text-foreground/90">
        ...
        <div className="mt-4 space-y-4 text-[15px] leading-relaxed text-foreground/90">
          ...
          <div>
            ...
            <p>
              ...
              berbagai sumber terpercaya yang berasal dari wilayah Kota Madya Gunungsitoli,
              Kabupaten Nias, Kabupaten Nias Utara, Kabupaten Nias Barat, dan Kabupaten Nias
              Selatan.
            </p>
          </div>
          <div>
        ...
        <p className="mt-3 text-[15px] leading-relaxed text-foreground/90">
          ...
          lengkap dan akurat. Kami menyadari bahwa website ini masih akan terus mengalami
          perkembangan baik dari segi jumlah kosakata maupun konten artikel seputar Nias. Untuk itu,
          jika ada saran kosakata baru, perbaikan, atau artikel yang ingin dipublikasikan, Anda
          dapat menyampaikannya melalui{" "}
          <Link to="/kontak" className="text-primary hover:underline">
            Halaman Kontak
          </Link>{" "}
          maupun{" "}
          <Link to="/saran" className="text-primary hover:underline">
            Form Saran Kata
          </Link>
          .
        </p>
        <p className="mt-3 text-[15px] leading-relaxed text-foreground/90">
          ...
          yang digunakan oleh masyarakat di Kota Madya Gunungsitoli, Kabupaten Nias, Kabupaten Nias
          Utara, Kabupaten Nias Barat, dan Kabupaten Nias Selatan. Kami berharap platform ini dapat
          menjadi salah satu sarana pelestarian bahasa daerah sekaligus membantu masyarakat dalam
          mempelajari dan menggunakan Bahasa Nias secara lebih luas, baik di Pulau Nias maupun di
          seluruh Indonesia.
        </p>
      </article>
